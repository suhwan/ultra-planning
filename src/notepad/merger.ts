/**
 * Notepad Merger - Cross-plan merge and summary generation
 *
 * Enables long-term learning accumulation by merging plan-level notepads
 * to project-level files and generating summaries for knowledge retrieval.
 */
...
export function generateProjectSummary(
  ...
  try {
    ...
    // Recent highlights (last 3 from each category)
